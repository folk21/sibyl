...
This is the final correctness gate before automatic build output is atomically published. It
checks foreign keys, required metadata, and non-empty persisted retrieval/display content.
"""
