"""Resumable local embedding cache for automatic corpus builds.

Completed batches are committed outside published runtime output so interrupted model work can be
reused on the next build when the exact input/configuration identity matches.
"""
