"""Deterministic automatic passage splitting for open-ended local retrieval.

Pipeline position:

    prepared canonical SourceDocument -> THIS MODULE -> PassageCandidate values
                                              -> hints/embeddings -> runtime corpus

This is intentionally a mechanical fallback path: it respects paragraphs/sentences and exact
character locators but does not claim literary understanding. LLM curation is a separate feature
that may select more meaningful ranges for guided questions.
"""
...
from .models import PassageCandidate
