...
from .preparation import _selection_registry_models
from .selection import load_selection
from .source_artifacts import read_source_artifact
...
def _work_toml(manifest, selected_work, artifact) -> str:
    ...
    _work, version = _selection_registry_models(manifest, selected_work)
